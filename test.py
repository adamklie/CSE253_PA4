...
def main(args, run_id):
    ...
    for i, (image_batch, caption_batch, length_batch) in enumerate(test_dataloader):
        ...
        if i == 0:
            ...
            writer.add_text('Test Image 2 Predicted Caption', caption[1], 1)
            writer.add_text('Test Image 3 Predicted Caption', caption[2], 1)
            writer.add_text('Test Image 4 Predicted Caption', caption[3], 1)
            writer.flush()
            break
